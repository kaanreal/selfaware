...
- See your own nametag in third person while Minecraft keeps its normal visibility rules.
- Match server-provided names, shadows, backgrounds, and team formatting.
- Toggle DonutSMP rank and balance rows independently on supported versions.
