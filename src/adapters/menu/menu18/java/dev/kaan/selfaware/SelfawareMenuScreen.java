...
public final class SelfawareMenuScreen extends Screen {
    ...
    protected void init() {
        ...
        addRenderableWidget(new Button(x, y + 60, 250, 20, SelfawareMenu.doneLabel(), button -> onClose()));
    }
    ...
    public void render(PoseStack poseStack, int mouseX, int mouseY, float partialTicks) {
        ...
        GuiComponent.drawCenteredString(poseStack, font, SelfawareMenu.title(), width / 2, height / 2 - 78, 0xFFFFFF);
